  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <h1 style={{ margin: 0, fontSize: "28px" }}>Tender Watch Dashboard</h1>
            <div style={{ color: "#64748b", marginTop: "8px" }}>
              Live matched tenders from Find a Tender
            </div>
          </div>
        ...
        {loading && <div style={{ padding: "16px 0" }}>Loading live tenders...</div>}
        ...
        {!loading && !apiError && filteredTenders.length === 0 && (
          ...
          >
            No live tenders matched your keyword bank in the last 30 days.
          </div>
        )}
        ...
        <div style={{ overflowX: "auto" }}>
          ...
          >
            <thead>
              <tr style={{ borderBottom: "1px solid #d1d5db", color: "#64748b", textAlign: "left" }}>
